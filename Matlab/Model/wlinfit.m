function [p,S,mu] = wlinfit(x,y,w)
%POLYFIT Fit polynomial to data.
%%%%% MODIFIED TO SUPPORT WEIGHTING, AS PER THE RECOMMENDATIONS OF
%%%%% http://www.walkingrandomly.com/?p=2942
%
...
% Modify Y as function of weights (W)
w=sqrt(w(:));
y=y.*w;
for j=1:n+1
    V(:,j) = w.*V(:,j);
